      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 py-12">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-acid rounded flex items-center justify-center shadow-glow-sm">
                <Wand2 size={14} className="text-black" />
              </div>
              <span className="font-display font-bold text-lg tracking-tight bg-gradient-to-r from-primary to-acid/80 bg-clip-text text-transparent">MemeGPT</span>
            </div>
            ...
            <div className="flex items-center gap-4 text-muted">
              <a href="#" className="hover:text-acid transition-colors duration-200">
              ...
              <Mail size={18} className="hover:text-acid transition-colors duration-200 cursor-pointer" />
            </div>
          </div>

          {/* Links */}
          <div>
            <h4 className="font-mono text-[10px] uppercase tracking-widest text-acid mb-4">Platform</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/" className="flex items-center gap-1 text-muted hover:text-acid transition-colors group">Generator <ArrowRight size={12} className="opacity-0 group-hover:opacity-100 transition-opacity" /></Link></li>
              <li><Link to="/gallery" className="flex items-center gap-1 text-muted hover:text-acid transition-colors group">Gallery <ArrowRight size={12} className="opacity-0 group-hover:opacity-100 transition-opacity" /></Link></li>
              <li><Link to="/gallery" className="flex items-center gap-1 text-muted hover:text-acid transition-colors group">Trending <ArrowRight size={12} className="opacity-0 group-hover:opacity-100 transition-opacity" /></Link></li>
              <li><Link to="/dashboard" className="flex items-center gap-1 text-muted hover:text-acid transition-colors group">Dashboard <ArrowRight size={12} className="opacity-0 group-hover:opacity-100 transition-opacity" /></Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-[10px] font-mono text-muted uppercase tracking-wider">
            <a href="#" className="hover:text-acid transition-colors duration-200">Privacy Policy</a>
            <a href="#" className="hover:text-acid transition-colors duration-200">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
